...
public class AdmFuncionalidadeRelController 
	extends BaseViewRelatorio<AdmFuncionalidade, Long, AdmFuncionalidadeService>
	...
	/**
	 * Instantiates a new AdmFuncionalidade rel MB.
	 */
	public AdmFuncionalidadeRelController() {
	...
	public String exportar(String tipoRelatorio, String forcarDownload) {		
		...
		relatorio = new BaseRelatorioImpl("AdmFuncionalidade");
