...
public class AdmFuncionarioRelController 
	extends BaseViewRelatorio<AdmFuncionario, Long, AdmFuncionarioService>
	...
	/**
	 * Instantiates a new AdmFuncionario rel MB.
	 */
	public AdmFuncionarioRelController() {
	...
	public String exportar(String tipoRelatorio, String forcarDownload) {		
		...
		relatorio = new BaseRelatorioImpl("AdmFuncionario");
