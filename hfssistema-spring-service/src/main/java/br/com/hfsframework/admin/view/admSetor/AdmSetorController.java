...
/**
 * The Class AdmSetorController.
 */
@Controller
@TratamentoErrosEsperados
@RequestMapping("/admSetorMB")
public class AdmSetorController
		extends BaseViewCadastro<AdmSetor, String, AdmSetorService>
		implements IBaseViewCadastro<AdmSetor, String>, IBaseViewRelatorio {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	@Autowired
	private AdmSetorRelController rel;
	
	/**
	 * Instantiates a new AdmSetorController.
	 */
	public AdmSetorController() {
		super(new AdmSetor(),
			"/private/admin/admSetor/listarAdmSetor",
			"/private/admin/admSetor/editarAdmSetor", 
			"/admSetorMB");
	}
	...
	public ModelAndView incluir() {
		return super.incluir(new AdmSetor());
	}
	...
	@Override
	@PostMapping("/salvar")
	public RedirectView salvar(@Valid AdmSetor obj, 
